...
# убрать нахуй
def cubes_rate_definition():
    if POOL_VALUE <= 50:
        pass

    elif 50 < POOL_VALUE < 70:
        pass

    elif 70 <= POOL_VALUE < 85:
        pass

    elif 85 <= POOL_VALUE < 100:
        pass
...
# /создать класс для кубов тип данных
# /определить коэф для каждого куба при разных размерах пула
# /функция понижения коэфициена с учётом размера пула игрока или максимального процента
